    ...
    return `
            <nav class="sidebar close">
                ...
                <div id="sidebar__list" class="sidebar__menu">
                    <div id="" class="sidebar__menu-option option__active" onclick="gestionarInvitaciones()">
                    ...
                    <div id="" class="sidebar__menu-option" onclick="gestionDeUsuarios()">
                    ...
                    <div id="" class="sidebar__menu-option" onclick="gestionarSalas()">
                    ...
                    <div id="" class="sidebar__menu-option" onclick="gestionarReuniones()">
